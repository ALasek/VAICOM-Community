    ...
    namespace Database
    {
        ...
        public static partial class Aliases
        {
            ...
            public static Dictionary<string, string> aicommands = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
            {
                ...
                // Petrovich AI gunner
                { "Petrovich Weapons On",                        "petrovichweaponson"             },
                { "Petrovich Prepare Weapons",                   "petrovichweaponson"             },
                { "Gunner Weapons On",                           "petrovichweaponson"             },
                { "Gunner Prepare Weapons",                      "petrovichweaponson"             },
                { "Petrovich Search Boresight",                  "petrovichsearchboresight"       },
                { "Gunner Search Boresight",                     "petrovichsearchboresight"       },
                { "Petrovich Search Forward",                    "petrovichsearchforward"         },
                { "Gunner Search Forward",                       "petrovichsearchforward"         },
                { "Petrovich Search Pilot Line Of Sight",        "petrovichsearchpilotlos"        },
                { "Gunner Search Pilot Line Of Sight",           "petrovichsearchpilotlos"        },
                { "Petrovich Clear Search",                      "petrovichclearsearch"           },
                { "Petrovich Stop Search",                       "petrovichclearsearch"           },
                { "Gunner Clear Search",                         "petrovichclearsearch"           },
                { "Gunner Stop Search",                          "petrovichclearsearch"           },
                { "Petrovich Toggle Target Selection",           "petrovichtargetingtoggle"       },
                { "Gunner Toggle Target Selection",              "petrovichtargetingtoggle"       },
                { "Petrovich Cycle Missile",                     "petrovichcyclemissile"          },
                { "Gunner Cycle Missile",                        "petrovichcyclemissile"          },
                { "Petrovich Fire",                              "petrovichfire"                  },
                { "Gunner Fire",                                 "petrovichfire"                  },
                { "Petrovich Toggle R O E",                      "petrovichroetoggle"             },
                { "Gunner Toggle R O E",                         "petrovichroetoggle"             },
                { "Petrovich Previous Target",                   "petrovichtargetprevious"        },
                { "Gunner Previous Target",                      "petrovichtargetprevious"        },
                { "Petrovich Next Target",                       "petrovichtargetnext"            },
                { "Gunner Next Target",                          "petrovichtargetnext"            },
                { "Petrovich Select Target",                     "petrovichtargetselect"          },
                { "Gunner Select Target",                        "petrovichtargetselect"          },
                { "Petrovich Countermeasure Interval",           "petrovichcminterval"            },
                { "Gunner Countermeasure Interval",              "petrovichcminterval"            },
                { "Petrovich Countermeasure Series",             "petrovichcmseries"              },
                { "Gunner Countermeasure Series",                "petrovichcmseries"              },
                { "Petrovich Countermeasures Left",              "petrovichcmleft"                },
                { "Gunner Countermeasures Left",                 "petrovichcmleft"                },
                { "Petrovich Countermeasures Right",             "petrovichcmright"               },
                { "Gunner Countermeasures Right",                "petrovichcmright"               },
                { "Petrovich Countermeasure Set",                "petrovichcmset"                 },
                { "Petrovich Countermeasure Type",               "petrovichcmset"                 },
                { "Gunner Countermeasure Set",                   "petrovichcmset"                 },
                { "Gunner Countermeasure Type",                  "petrovichcmset"                 },
                { "Petrovich Dispense Countermeasures",          "petrovichcmdispense"            },
                { "Petrovich Flares",                            "petrovichcmdispense"            },
                { "Gunner Dispense Countermeasures",             "petrovichcmdispense"            },
                { "Gunner Flares",                               "petrovichcmdispense"            },
