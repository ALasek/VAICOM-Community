    ...
    namespace Database
    {
        ...
        public static partial class Labels
        {
            ...
            public static Dictionary<string, string> aicommands = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
            {
                ...
                // Petrovich AI gunner
                { "petrovichweaponson",       "Petrovich Prepare Weapons" },
                { "petrovichsearchboresight", "Petrovich Search Boresight" },
                { "petrovichsearchforward",   "Petrovich Search Forward" },
                { "petrovichsearchpilotlos",  "Petrovich Search Pilot LOS" },
                { "petrovichclearsearch",     "Petrovich Clear/Stop Search" },
                { "petrovichtargetingtoggle", "Petrovich Toggle Target Selection" },
                { "petrovichcyclemissile",    "Petrovich Cycle Missile Type" },
                { "petrovichfire",            "Petrovich Fire" },
                { "petrovichroetoggle",       "Petrovich Toggle ROE" },
                { "petrovichtargetprevious",  "Petrovich Previous Target" },
                { "petrovichtargetnext",      "Petrovich Next Target" },
                { "petrovichtargetselect",    "Petrovich Select Target" },
                { "petrovichcminterval",      "Petrovich Cycle Countermeasure Interval" },
                { "petrovichcmseries",        "Petrovich Cycle Countermeasure Series" },
                { "petrovichcmleft",          "Petrovich Countermeasures Left" },
                { "petrovichcmright",         "Petrovich Countermeasures Right" },
                { "petrovichcmset",           "Petrovich Cycle Countermeasure Set" },
                { "petrovichcmdispense",      "Petrovich Dispense Countermeasures" },
